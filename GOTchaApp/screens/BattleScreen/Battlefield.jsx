...
const Battlefield = ({ fieldInformation, setSquare }) => {
  const { fieldPattern, attackState } = fieldInformation;
          ...
          {row.map((spot, columnIndex) => {
            ...
            return (
              ...
              >
                ...
                <Text style={spot !== "" ? styles.drawStatAttackToken : {}}>
                  {spot[3]}
                </Text>
                <Text style={spot !== "" ? styles.drawStatDefenseToken : {}}>
                  {spot[4]}
                </Text>
              </View>
            );
