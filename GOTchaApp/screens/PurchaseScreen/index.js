...
const PurchaseScreen = (props) => {
  const [purchaseOverlayVisible, setPurchaseOverlayVisible] = React.useState(false);

  const footerOptions = props.route.params;
  return (
    <>
      <PurchaseOverlay
        isVisible={purchaseOverlayVisible}
        toggleOverlay={setPurchaseOverlayVisible}
      />
        ...
        <View style={styles.drawingContainer}>
          ...
          <View style={styles.button} style={styles.btnContainer}>
            <Button
              ...
              onPress={() => setPurchaseOverlayVisible(true)}
              icon={
                <Icon
                  name="credit-card"
                  size={40}
